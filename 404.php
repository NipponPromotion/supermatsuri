<?php
$title="Page Couldn't Found– Nippon Promotion";
$meta_title="Page Couldn't Found– Nippon Promotion";
$meta_type="article";
...
$meta_description="Page couldn't found";
...
$isim=str_replace("_"," ",$asil);


  $sql = "SELECT * FROM performers where perf_name='$isim'";
...
<div id='sayfabilgisi' adi='dortyuzdort' style='display: none;'></div>
<div class='icerik'>
  <div class='container'>
<div class='col-12 text-center'>
	  ...
	  <div class='col-12 text-center'>
	  <h3>". _DORTYUZDORT ."</h3>
		  <h5>". _DORTYUZDORTACIKLAMA ."</h5>
	  
	  </div>
	  
	  <div class='col-sm-12 col-md-4 col-lg-4 mt-4 mb-4 border'>
		 <a href='/index.php'> <li>To Main Page</li></a>
		<a href='/performers.php'><li>To Performers Page</li></a>  
	  	<a href='/watch.php'>	<li>To Live Stream Page</li></a>
